...
// ---------- ---------- ---------- ---------- ----------
/**
 * Google Identity Services の ID認証クライアント
 */
...
// ---------- ---------- ---------- ---------- ----------
/**
 * Google Identity Services のルートオブジェクト
 */
interface Google {
 ...
 */
const getGoogle = async (): Promise<Google> => {
 ...
 * ユーザー情報を取得する
 */
const getGoogleAuthResult = (idToken: string): GoogleAuthResult => {
 ...
 */
const getAccessToken = async (config: GetAccessTokenConfig): Promise<string> => {
